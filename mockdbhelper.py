...
class MockDBHelper:
    ...
    def add_table(self, number, owner):
        MOCK_TABLES.append({"_id": str(number), "number": str(number), "owner": str(owner)})
        return number
    ...
    def add_request(self, table_id, time):
        MOCK_REQUESTS.append({"_id": str(table_id), "table_number": str(table_id), "table_id": str(table_id), "time": time})
